package com.nps.adiscope.sampleapp;
...
import com.nps.adiscope.sampleapp.ads.applovin.banner.BannerDemoMenuActivity;
import com.nps.adiscope.sampleapp.ads.applovin.eventtracking.EventTrackingActivity;
import com.nps.adiscope.sampleapp.ads.applovin.interstitials.InterstitialDemoMenuActivity;
import com.nps.adiscope.sampleapp.ads.applovin.leaders.LeaderDemoMenuActivity;
import com.nps.adiscope.sampleapp.ads.applovin.rewarded.RewardedVideosDemoMenuActivity;
import com.nps.adiscope.sampleapp.ads.max.InterstitialAdActivity;
import com.nps.adiscope.sampleapp.ads.max.RewardedAdActivity;
import com.nps.adiscope.sampleapp.ads.max.banner.BannerAdActivity;
import com.nps.adiscope.sampleapp.ads.max.mrecs.MrecAdActivity;
import com.nps.adiscope.sampleapp.data.main.DemoMenuItem;
import com.nps.adiscope.sampleapp.data.main.FooterType;
import com.nps.adiscope.sampleapp.data.main.ListItem;
import com.nps.adiscope.sampleapp.data.main.SectionHeader;
import com.nps.adiscope.sampleapp.ui.MainRecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppLovinSdk.getInstance(this).initializeSdk(new AppLovinSdk.SdkInitializationListener() {
            ...
            public void onSdkInitialized(final AppLovinSdkConfiguration config) {
                Log.d("adiscope", "onSdkInitialized : " + config.getConsentDialogState().name());
